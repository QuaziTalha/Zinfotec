        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-5 md-mb-50px"
                    ...
                    <h3 class="text-dark-gray fw-700 ls-minus-2px w-90 md-w-100">Ready to illuminate your vision? Let's
                        bring your LED display project to life – reach out to us today!
                    </h3>
                    ...
                    <div class="row row-cols-1 justify-content-center mt-30px">
                        ...
                        <div class="col icon-with-text-style-08">
                            <div class="feature-box feature-box-left-icon-middle overflow-hidden">
                                <div class="feature-box-icon feature-box-icon-rounded  w-80px h-80px rounded-circle me-20px"
                                    style="background: #0082cc ;">
                                ...
                                <div class="feature-box-content last-paragraph-no-margin">
                                    ...
                                    <span class="d-block fs-22 text-dark-gray ls-minus-05px fw-600"><a
                                            href="cdn-cgi/l/email-protection.html#6e0d0f1c0b0b1c1d2e0a01030f0700400d0103"
                                            class="text-dark-gray text-decoration-line-bottom"><span class="__cf_email__"
                                                data-cfemail="91f2f0e3f4f4e3e2d1f5fefcf0f8ffbff2fefc">[email&#160;protected]</span></a></span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row row-cols-1 row-cols-sm-2 justify-content-center">
                        <div class="col xs-mb-30px"
                            ...
                            <div class="bg-very-light-gray h-100 fs-17 lh-30 p-35px lg-p-25px border-radius-5px">
                                <img src="public/images/logo.png" alt class="border-radius-4px mb-30px lg-mb-20px">
                                <span class="alt-font text-dark-gray fs-19 fw-600 d-inline-block">Zinfotec -
                                    Aurangabad</span>
                                <p class="mb-15px">Basement Supreme Commerce Classes, Khokadpura, Near Paithan Gate,
                                    Aurangabad(MS)</p>
            ...
            <div class="row row-cols-md-1 justify-content-center">
                <div class="col-xl-10">
                    <div class="bg-white p-8 border-radius-6px box-shadow-double-large">
                        ...
                        <form action="database.php" method="post" class="row contact-form-style-02">
                ...
                <div class="row align-items-center justify-content-center mt-8">
                    ...
                    <div class="col-md-auto elements-social social-icon-style-04 text-center text-md-start ps-lg-0">
                        <ul class="large-icon dark">
                            ...
                            <li class="m-0"><a class="instagram" href="https://www.instagram.com/" target="_blank"><i
