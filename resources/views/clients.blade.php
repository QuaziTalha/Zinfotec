...
@section('content')
        ...
        <div class="container-fluid">
            <div class="row row-cols-1 row-cols-md-4 row-cols-sm-2 clients-style-06 appear anime-child anime-complete"
                ...
                @foreach ($imageNames as $imageName)
                    <div class="col client-box text-center pt-6 pb-6 sm-pt-8 sm-pb-8" style="">
    ...
    <section class="bg-solitude-blue overflow-hidden xs-pb-20px">
        ...
        <span class="bg-white box-shadow-quadruple-large text-uppercase fs-13 ps-25px pe-25px alt-font fw-600 text-base-color lh-40 sm-lh-55 border-radius-100px d-inline-block mb-25px" style="">Customer speaks</span>
        <h3 class="alt-font text-dark-gray fw-600 ls-minus-1px mb-0" style="">What our valuable customer are saying?</h3>
        </div>
        </div>
        <div class="row align-items-center">
        <div class="col-12 position-relative appear anime-complete" data-anime="{ &quot;translateX&quot;: [50, 0], &quot;opacity&quot;: [0,1], &quot;duration&quot;: 600, &quot;delay&quot;: 100, &quot;staggervalue&quot;: 300, &quot;easing&quot;: &quot;easeOutQuad&quot; }" style="">
