    ...
    <section class="container sproduct my-5 pt-5">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-sm-12">
                <img class="img-fluid w-100 pd-10" id="MainImg" src="public/images/Products/P6.png" data-main-image
                    alt="">
            ...
            <div class="col-lg-6 ">
                <div class="single-product-details ">
                    <div class="single-product-title">
                        <h2 class="text-black" style="margin: 30px 0;">Indoor P6</h2>
    ...
    <section class="pt-0 ps-6 pe-6 lg-ps-2 lg-pe-2 sm-ps-0 sm-pe-0 padding-xl" style="padding-top: 50px;">
        <div class="container-fluid ">
            <div class="row flex-row-reverse">
                <div class="col-xxl-12 pt-0px col-lg-9 ps-5 md-ps-15px md-mb-60px ">
