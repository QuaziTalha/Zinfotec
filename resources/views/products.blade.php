            ...
            <div class="row flex-row-reverse">
                <div class="col-xxl-12 pt-50px col-lg-9 ps-5 md-ps-15px md-mb-60px ">
                    <ul class="shop-modern shop-wrapper grid grid-4col xl-grid-3col sm-grid-2col xs-grid-1col gutter-extra-large text-center appear anime-child anime-complete"
                        ...
                        <li class="grid-item" style="position: absolute; left: 0%; top: 0px; transition: none 0s ease 0s;">
                            <div class="shop-box mb-10px">
                                <div class="shop-image mb-20px">
                                    <a href="#">
                                        <img src="{{ url('public/images/demo-accounting-img-01.jpg') }}" alt=""
                                            data-no-retina="">
                        ...
                        <li class="grid-item"
                            style="position: absolute; left: 49.9993%; top: 0px; transition: none 0s ease 0s; transform: translate3d(0px, 0px, 0px);">
                            <div class="shop-box mb-10px">
                                <div class="shop-image mb-20px">
                                    <a href="#">
                                        <img src="{{ url('public/images/demo-accounting-img-01.jpg') }}" alt=""
                        ...
                        <li class="grid-item"
                            style="position: absolute; left: 74.999%; top: 0px; transition: none 0s ease 0s; transform: translate3d(-0.0019999px, 0px, 0px);">
                            <div class="shop-box mb-10px">
                                <div class="shop-image mb-20px">
                                    <a href="#">
                                        <img src="{{ url('public/images/demo-accounting-img-01.jpg') }}" alt=""
                        ...
                        <li class="grid-item"
                            style="position: absolute; left: 0%; top: 600.016px; transition-behavior: normal; transition-timing-function: ease;">
                            <div class="shop-box mb-10px">
                                <div class="shop-image mb-20px">
                                    <a href="#">
                                        <img src="{{ url('public/images/demo-accounting-img-01.jpg') }}" alt=""
                        ...
                        <li class="grid-item"
                            style="position: absolute; left: 24.9997%; top: 499.656px; transition: none 0s ease 0s; transform: translate3d(0px, 100.36px, 0px);">
                            <div class="shop-box mb-10px">
                                <div class="shop-image mb-20px">
                                    <a href="#">
                                        <img src="{{ url('public/images/demo-accounting-img-01.jpg') }}" alt=""
                        ...
                        <li class="grid-item"
                            style="position: absolute; left: 49.9993%; top: 499.656px; transition: none 0s ease 0s; transform: translate3d(0px, 100.36px, 0px);">
                            <div class="shop-box mb-10px">
                                <div class="shop-image mb-20px">
                                    <a href="#">
                                        <img src="{{ url('public/images/demo-accounting-img-01.jpg') }}" alt=""
                        ...
                        <li class="grid-item"
                            style="position: absolute; left: 74.999%; top: 499.656px; transition: none 0s ease 0s; transform: translate3d(-0.0019999px, 100.36px, 0px);">
                            <div class="shop-box mb-10px">
                                <div class="shop-image mb-20px">
                                    <a href="#">
                                        <img src="{{ url('public/images/demo-accounting-img-01.jpg') }}" alt=""
                        ...
                        <li class="grid-item"
                            style="position: absolute; left: 0%; top: 1200.03px; transition-behavior: normal; transition-timing-function: ease;">
                            <div class="shop-box mb-10px">
                                <div class="shop-image mb-20px">
                                    <a href="#">
                                        <img src="{{ url('public/images/demo-accounting-img-01.jpg') }}" alt=""
                        ...
                        <li class="grid-item"
                            style="position: absolute; left: 24.9997%; top: 999.312px; transition: none 0s ease 0s; transform: translate3d(0px, 200.72px, 0px);">
                            <div class="shop-box mb-10px">
                                <div class="shop-image mb-20px">
                                    <a href="#">
                                        <img src="{{ url('public/images/demo-accounting-img-01.jpg') }}" alt=""
                        ...
                        <li class="grid-item"
                            style="position: absolute; left: 49.9993%; top: 999.312px; transition: none 0s ease 0s; transform: translate3d(0px, 200.72px, 0px);">
                            <div class="shop-box mb-10px">
                                <div class="shop-image mb-20px">
                                    <a href="#">
                                        <img src="{{ url('public/images/demo-accounting-img-01.jpg') }}" alt=""
                        ...
                        <li class="grid-item"
                            style="position: absolute; left: 74.999%; top: 999.312px; transition: none 0s ease 0s; transform: translate3d(-0.0019999px, 200.72px, 0px);">
                            <div class="shop-box mb-10px">
                                <div class="shop-image mb-20px">
                                    <a href="#">
                                        <img src="{{ url('public/images/demo-accounting-img-01.jpg') }}" alt=""
    ...
    ">
                    <div class="mb-30px" style="">
                        ...
                        <ul class="shop-filter category-filter fs-16">
                            <li><a href="#"><span class="product-cb product-category-cb"></span>Jeans</a><span
                                    class="item-qty">22</span></li>
                            <li><a href="#"><span class="product-cb product-category-cb"></span>Trousers</a><span
                                    class="item-qty">28</span></li>
                            <li><a href="#"><span class="product-cb product-category-cb"></span>Swimwear</a><span
                                    class="item-qty">36</span></li>
                            <li><a href="#"><span class="product-cb product-category-cb"></span>Casual
                                    shirts</a><span class="item-qty">24</span></li>
                            <li><a href="#"><span class="product-cb product-category-cb"></span>Winter
                                    jackets</a><span class="item-qty">26</span></li>
                            <li><a href="#"><span class="product-cb product-category-cb"></span>Leggings</a><span
                                    class="item-qty">33</span></li>
                            <li><a href="#"><span class="product-cb product-category-cb"></span>Dupattas</a><span
                                    class="item-qty">22</span></li>
                        </ul>
                    </div>
                    <div class="mb-30px" style="">
                    ...
                    <div class="mb-30px" style="">
                        <div class="d-flex align-items-center mb-20px">
                            ...
                            <div class="d-flex ms-auto">
                                ...
                                <div class="slider-one-slide-prev-1 icon-very-small swiper-button-prev slider-navigation-style-08 me-5px"
                                    tabindex="0" role="button" aria-label="Previous slide"
                                    aria-controls="swiper-wrapper-95d1dd5a47ff96c6"><i
                                        class="fa-solid fa-arrow-left text-dark-gray"></i></div>
                                <div class="slider-one-slide-next-1 icon-very-small swiper-button-next slider-navigation-style-08 ms-5px"
                                    tabindex="0" role="button" aria-label="Next slide"
                                    aria-controls="swiper-wrapper-95d1dd5a47ff96c6"><i
                                        class="fa-solid fa-arrow-right text-dark-gray"></i></div>

                            </div>
                        </div>
                        <div class="swiper slider-one-slide swiper-initialized swiper-horizontal swiper-backface-hidden"
                            ...
                            <div class="swiper-wrapper" id="swiper-wrapper-95d1dd5a47ff96c6" aria-live="off"
                                style="transition-duration: 300ms; transform: translate3d(-249px, 0px, 0px);">
                                ...
                                <div class="swiper-slide swiper-slide-next swiper-slide-prev" role="group"
                                    aria-label="2 / 2" style="width: 249px;" data-swiper-slide-index="1">
                                    <div class="shop-filter new-arribals">
                                        <div class="d-flex align-items-center mb-20px">
                                            <figure class="mb-0">
                                                <a href="#">
                                                    <img class="border-radius-4px w-80px"
                                                        src="{{ url('public/images/demo-accounting-img-01.jpg') }}"
                                                        alt="" data-no-retina="">
                                                </a>
                                            </figure>
                                ...
                                <div class="swiper-slide swiper-slide-active" style="width: 249px;" role="group"
